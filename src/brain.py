...
def call_gemini(paper: dict, lang: str = "en") -> tuple:
    ...
    user_prompt = f"""Here is a recent paper in aerospace research:
...
def generate_hugo_post(gemini_output: dict, paper: dict, lang: str = "en") -> str:
    ...
    # Attribution footer
    if lang == "tr":
        attribution = "*Bu makale incelemesi [Gemini 2.5 Flash](https://deepmind.google/technologies/gemini/) tarafindan olusturulmus ve AeroSentinel v2.5.0 tarafindan duzenlenmistir.*"
        lbl_reference = "Kaynak"
    else:
        attribution = "*This paper review was generated by [Gemini 2.5 Flash](https://deepmind.google/technologies/gemini/) and curated by AeroSentinel v2.5.0.*"
